...
@Component({
  selector: 'app-main-medecin',
  templateUrl: './main-medecin.component.html',
  styleUrls: ['./main-medecin.component.css']
})
export class MainMedecinComponent implements OnInit {
