...
declare var $: any;
@Component({
  selector: 'app-main-directeur',
  templateUrl: './main-directeur.component.html',
  styleUrls: ['./main-directeur.component.css']
})
export class MainDirecteurComponent implements OnInit {
